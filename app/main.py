...
def add_predictions(input_data):
    ...
    st.write("Cell cluster predictions")
    ...
    st.write("The probability of benign", model.predict_proba(input_array_scaled)[0][0])
    st.write("The probability of malicious", model.predict_proba(input_array_scaled)[0][1])
...
def main():
    ...
    with st.container():
        ...
        st.write("App will help diagnoise breast cancer from tissue sample")
